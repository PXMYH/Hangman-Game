...
public class HangmanCanvas extends GCanvas {
	...
	private  double pt_a_x = getWidth() / 2 - BEAM_LENGTH;
	private  double pt_a_y = getHeight() * 38 / 50;
	private  double pt_b_x = pt_a_x;
	private  double pt_b_y = pt_a_y - SCAFFOLD_HEIGHT;
...
//		double pt_d_y = pt_c_y + ROPE_LENGTH;
		...
		//rope = new GLine(getWidth() / 2, getWidth() / 2 - BEAM_LENGTH -SCAFFOLD_HEIGHT, getWidth() / 2, getWidth() / 2 - BEAM_LENGTH -SCAFFOLD_HEIGHT + ROPE_LENGTH);
		add(scaffold);
		//add(beam);
		//add(rope);
	}
